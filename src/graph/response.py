...
def finalize(agent: Any, graph_result: dict[str, Any], started: float) -> dict[str, Any]:
    ...
    if completed.response:
        ...
        completed.response["observability"] = {
            ...
            "teaching_mode": completed.teaching_mode,
            "current_concept_mastery": completed.current_concept_mastery,
            "prerequisite_mastery": completed.prerequisite_mastery,
            "assessment_result": completed.assessment_result,
            "grading_method": completed.assessment_result.get("grading_method") if completed.assessment_result else None,
